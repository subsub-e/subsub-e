...
def draw(canvas):
    ...
    if (ball_pos[1] <= (paddle1_pos - HALF_PAD_HEIGHT) or ball_pos[1] >= (paddle1_pos + HALF_PAD_HEIGHT)) and ball_pos[
        0] <= (BALL_RADIUS + PAD_WIDTH + 8):
        score2 += 1
        spawn_ball(RIGHT)
    if (ball_pos[1] <= (paddle2_pos - HALF_PAD_HEIGHT) or ball_pos[1] >= (paddle2_pos + HALF_PAD_HEIGHT)) and ball_pos[
        0] >= WIDTH - (BALL_RADIUS + PAD_WIDTH + 8):
        score1 += 1
        spawn_ball(LEFT)
